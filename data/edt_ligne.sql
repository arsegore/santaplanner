SELECT DISTINCT jour.nom AS 'Jour', semaine.numero AS 'Semaine', semaine.mois AS 'Mois', creneau.heure_debut AS 'Début', creneau.heure_fin AS 'Fin', travaille.id_ligne AS 'Numero de ligne'
FROM travaille
