SELECT semaine.id AS 'Semaine', lutin.nom AS 'Lutin', jour.nom AS 'Jour', creneau.heure_debut AS 'Début', creneau.heure_fin AS 'Fin', travaille.id_ligne AS 'Numero de ligne'
FROM travaille
